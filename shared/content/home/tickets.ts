...
export type TicketInfo = {
  id: string;
  variant: "guest" | "standard" | "maxi" | "vip";
  imageUrl: string;
  imageAlt: string;
  title: string;
...
export const HOME_TICKET_SECTION = {
  ...
  battleCard: {
    ...
    note: "* Список подарунків буде доповнюватися після підтвердження партнерів. Минулого року загальна вартість подарунків для переможця перевищила 5000 zł.",
  },
};
