...
export const FooterInfoSection: React.FC<FooterInfoSectionProps> = ({
  ...
  return (
    ...
    >
      <section data-ui="footer-shell" className="relative isolate min-h-96 overflow-hidden rounded-t-2xl bg-blue-foreground px-4 pb-8 pt-8 text-center md:px-8">
        <img
        ...
        <div data-ui="footer-content" className="relative z-[1] mx-auto flex w-full max-w-sm flex-col items-center gap-5">
          <div data-ui="footer-company" className="flex flex-col items-center gap-4">
            <h3 data-ui="footer-company-title" className="text-2xl font-semibold uppercase leading-tight tracking-tight text-text-inverse">
              ДАНІ КОМПАНІЇ
            </h3>
            <div data-ui="footer-company-text" className="space-y-0.5 text-sm font-medium leading-relaxed tracking-tight text-text-inverse">
          ...
          <div data-ui="footer-contact" className="flex flex-col items-center gap-4">
            <h3 data-ui="footer-contact-title" className="text-2xl font-semibold uppercase leading-tight tracking-tight text-text-inverse">
              КОНТАКТНА ТОЧКА
            </h3>
            <Link
          ...
          <div data-ui="footer-support" className="flex flex-col items-center gap-4">
            <h3 data-ui="footer-support-title" className="text-2xl font-semibold uppercase leading-tight tracking-tight text-text-inverse">
              ВІДДІЛ ТУРБОТИ
            </h3>
            <p data-ui="footer-support-text" className="whitespace-pre-line text-sm font-medium leading-relaxed tracking-tight text-text-inverse">
          ...
          <div data-ui="footer-meta" className="mt-2.5 space-y-1 text-sm font-medium leading-relaxed tracking-tight text-text-inverse">
