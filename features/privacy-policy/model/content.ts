export const PRIVACY_POLICY_CONTENT = {
  ...
  description:
    "Zebraliśmy najważniejsze informacje o przetwarzaniu danych osobowych w jednym miejscu.",
  intro:
    "Niniejsza Polityka Prywatności określa zasady przetwarzania i ochrony danych osobowych osób korzystających z serwisu internetowego dostępnego pod adresem nailmoment.pl (dalej: \"Serwis\"). Polityka została sporządzona zgodnie z Rozporządzeniem Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia 27 kwietnia 2016 r. (RODO), Ustawą z dnia 10 maja 2018 r. o ochronie danych osobowych oraz Ustawą z dnia 12 lipca 2024 r. \u2013 Prawo komunikacji elektronicznej (PKE).",
  sections: [
    {
      id: "administrator",
    ...
    {
      id: "recipients",
      title: "\u00a7 3. Odbiorcy danych osobowych",
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        "W zwi\u0105zku z korzystaniem z us\u0142ug Vercel Inc. oraz Stripe Inc. dane osobowe mog\u0105 by\u0107 przekazywane do Stan\u00f3w Zjednoczonych. Przekazywanie odbywa si\u0119 na podstawie decyzji Komisji Europejskiej z dnia 10 lipca 2023 r. o adekwatno\u015bci ochrony zapewnianej przez Ramy Ochrony Danych UE\u2013USA (EU-US Data Privacy Framework). Vercel Inc. oraz Stripe Inc. s\u0105 certyfikowane w ramach DPF.",
    ...
    },
    {
      ...
      paragraphs: [
        "Serwis nie stosuje plik\u00f3w cookies w celach analitycznych ani marketingowych. Us\u0142ugi Vercel Analytics oraz Vercel Speed Insights, z kt\u00f3rych korzysta Serwis, dzia\u0142aj\u0105 bez plik\u00f3w cookies i nie zapisuj\u0105 \u017cadnych identyfikator\u00f3w na urz\u0105dzeniu U\u017cytkownika.",
        "Pliki cookies mog\u0105 by\u0107 wykorzystywane wy\u0142\u0105cznie w zakresie niezb\u0119dnym do prawid\u0142owego funkcjonowania Serwisu (cookies techniczne/sesyjne). Stosowanie takich cookies nie wymaga zgody U\u017cytkownika na podstawie art. 399 ust. 3 ustawy Prawo komunikacji elektronicznej (PKE).",
        "U\u017cytkownik mo\u017ce w ka\u017cdej chwili zmieni\u0107 ustawienia dotycz\u0105ce plik\u00f3w cookies w swojej przegl\u0105darce internetowej, w tym ca\u0142kowicie zablokowa\u0107 ich zapisywanie.",
      ],
    },
    {
      id: "external-links",
      title: "\u00a7 8. Linki do serwis\u00f3w zewn\u0119trznych",
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Polityka Prywatno\u015bci obowi\u0105zuje od dnia 7 kwietnia 2026 r.",
      ],
    },
  ],
};
